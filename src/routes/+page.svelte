...
<div class="space-y-6">
  ...
  >
    <div class="flex items-center gap-2">
      ...
      <span class="text-sm font-semibold text-slate-800"><span class="num">{liveAgents}</span> agents online</span>
    </div>
    ...
    <span class="text-slate-300">·</span>
    <span class="text-sm text-slate-600">
      <span class="num font-semibold text-slate-800">{fteSaved}</span> FTE replaced
    </span>
    <span class="text-slate-300">·</span>
    <span class="text-sm text-slate-600">
      <span class="num font-semibold text-slate-800">${(annualSavings / 1_000_000).toFixed(1)}M</span> saved annually
    </span>
