<script lang="ts">
  ...
  function statusCls(s: string): string {
    ...
    if (s === 'closed')        return 'bg-emerald-50 text-emerald-700 ring-emerald-200';
...
<div class="space-y-6">
  ...
  <div class="card p-5">
    <div class="flex items-start gap-3">
      <div class="rounded-lg bg-emerald-50 p-2 text-emerald-700"><ClipboardCheck class="h-5 w-5" /></div>
      <div class="flex-1">
  ...
  <div class="card overflow-hidden">
    ...
    {:else if tab === 'pack'}
      <div class="space-y-4 p-5">
        <div class="flex items-start gap-3 rounded-xl border-2 border-emerald-300 bg-gradient-to-br from-emerald-50 to-white px-5 py-4">
          <div class="rounded-lg bg-emerald-100 p-2 text-emerald-700">
            <Zap class="h-5 w-5" />
          </div>
          <div class="flex-1">
            <div class="flex items-center gap-2">
              <span class="text-sm font-semibold text-emerald-900">Generated by Audit Companion agent</span>
